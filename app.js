var defaultIcon, highlightedIcon, largeInfowindow, bounds, q;
var markers = [];
var locations = [
...
var ViewModel = function() {
  ...
  // Check to make sure the infowindow is not already opened on this marker.
    ...
    this.initMap = function() {
        ...
        defaultIcon = self.makeMarkerIcon('0091ff');
        highlightedIcon = self.makeMarkerIcon('FF0000');
    ...
    this.popInfo = function(place) {
      ...
      self.populateInfoWindow(markers[index], largeInfowindow);
    }
} 

//initialise is the callback function
function initialise() {
